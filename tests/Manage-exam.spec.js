...
test.describe('test for manage exam ', () => {
  ...
  test('test for assigning student marks', async ({ page }) => {
    ...
    await page.getByTestId('select-group').selectOption('xL5HMu4fflNA,Final');
    await page.getByRole('button', { name: 'Assign' }).first().click();
    await page.getByLabel('Test1').getByTestId('add-marks').click();
    await page.getByLabel('Test1').getByTestId('add-marks').fill('80');
    await page.getByLabel('Test2').getByTestId('add-marks').click();
    await page.getByLabel('Test2').getByTestId('add-marks').fill('80');
    ...
    await page.getByLabel('Test1').getByTestId('add-marks').click();
    await page.getByLabel('Test1').getByTestId('add-marks').fill('85');
    await page.getByLabel('Test2').getByTestId('add-marks').click();
    await page.getByLabel('Test2').getByTestId('add-marks').fill('85');
    await page.getByRole('button', { name: 'Submit Marks' }).click();
    await page.getByTestId('select-class').selectOption('1NPSHbFN5Zfn,Class-4th');
    await page.getByTestId('select-batch').selectOption('NOnCHmqIv50R,Class-4th-A-2024');
    await page.getByTestId('select-group').selectOption('xL5HMu4fflNA,Final');
    ...
    await page.getByLabel('Test1').getByTestId('add-marks').click();
    await page.getByLabel('Test1').getByTestId('add-marks').fill('90');
    await page.getByLabel('Test2').getByTestId('add-marks').click();
    await page.getByLabel('Test2').getByTestId('add-marks').fill('90');
    await page.getByRole('button', { name: 'Submit Marks' }).click();
  });
  ...
  test('test for editing student marks', async ({ page }) => {
    ...
    await page.getByLabel('Test1').getByTestId('edit-marks').click();
    await page.getByLabel('Test1').getByTestId('edit-marks').fill('85');
    await page.getByLabel('Test2').getByTestId('edit-marks').click();
    await page.getByLabel('Test2').getByTestId('edit-marks').fill('85');
    await page.getByRole('button', { name: 'Submit Marks' }).click();
    await page.getByTestId('select-class').selectOption('1NPSHbFN5Zfn,Class-4th');
    await page.getByTestId('select-batch').selectOption('NOnCHmqIv50R,Class-4th-A-2024');
    await page.getByTestId('select-group').selectOption('xL5HMu4fflNA,Final');
    ...
    await page.getByLabel('Test1').getByTestId('edit-marks').click();
    await page.getByLabel('Test1').getByTestId('edit-marks').fill('75');
    await page.getByLabel('Test2').getByTestId('edit-marks').click();
    await page.getByLabel('Test2').getByTestId('edit-marks').fill('75');
    await page.getByRole('button', { name: 'Submit Marks' }).click();
    await page.getByTestId('select-class').selectOption('1NPSHbFN5Zfn,Class-4th');
    await page.getByTestId('select-batch').selectOption('NOnCHmqIv50R,Class-4th-A-2024');
    await page.getByTestId('select-group').selectOption('xL5HMu4fflNA,Final');
    ...
    await page.getByLabel('Test1').getByTestId('edit-marks').click();
    await page.getByLabel('Test1').getByTestId('edit-marks').fill('80');
    await page.getByLabel('Test2').getByTestId('edit-marks').click();
    await page.getByLabel('Test2').getByTestId('edit-marks').fill('80');
    await page.getByRole('button', { name: 'Submit Marks' }).click();
  });
  ...
  test('test for Exam Report Before Publish Result', async ({ page }) => {
    ...
    await page.getByTestId('select-class').selectOption('1NPSHbFN5Zfn,class-4th');
    await page.getByTestId('select-batch').selectOption('NOnCHmqIv50R,class-4th-A-2024');
    await page.getByTestId('select-group').selectOption('xL5HMu4fflNA-undefined');
  ...
  test('test for printing marksheet for school', async ({ page }) => {
    ...
    await page.getByTestId('select-batch').selectOption('NOnCHmqIv50R,Class-4th-A-2024,');
    await page.getByTestId('select-group').selectOption('xL5HMu4fflNA-Final');
    await page.getByTestId('select-student').selectOption('MAcgiyka7GR1-Test1');

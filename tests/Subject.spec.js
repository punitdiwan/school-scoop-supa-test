...
test('test for creating Elective Subject', async ({ page }) => {
  ...
  await page.getByRole('link', { name: 'Manage Elective Subject' }).click();
  await page.locator('div').filter({ hasText: /^Select Class class-4th class-6th$/ }).getByRole('combobox').selectOption('P63FiTHZYVl7,class-6th');
  await page.getByRole('combobox').nth(1).selectOption('EWYvDK0YxC8Z,class-6th-A-2024');
  await page.getByRole('button', { name: '+ Add Group' }).click();
  await page.getByLabel('Name *').click();
...
test('test for Assign elective Subject To Students', async ({ page }) => {
  ...
  await page.locator('div').filter({ hasText: /^Select Classclass-4thclass-6th$/ }).getByRole('combobox').selectOption('P63FiTHZYVl7,class-6th');
  await page.locator('div').filter({ hasText: /^Selectclass-6th-A-2024$/ }).getByRole('combobox').selectOption('EWYvDK0YxC8Z,class-6th-A-2024');
  await page.locator('div').filter({ hasText: /^Group \* Selectelective sub$/ }).getByRole('combobox').selectOption('class-6th-A-2024-electivesub,elective sub');
  await page.locator('div').filter({ hasText: /^Elective Subject \* Selectbiophy$/ }).getByRole('combobox').selectOption('MthEC9A862ej,bio');
  await page.locator('tr').filter({ hasText: 'test3test3' }).locator('svg').click();
  await page.getByRole('button', { name: 'Assign', exact: true }).click();
  await page.locator('div').filter({ hasText: /^Elective Subject \* Selectbiophy$/ }).getByRole('combobox').selectOption('39MbkgrM25w8,phy');

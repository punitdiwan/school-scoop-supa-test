...
//   await page.getByTestId('select-class').click();
//   await page.getByRole('listbox', { name: 'Class List' }).click();
...
//   await page.getByTestId('input-batch').click();
//   await page.getByTestId('input-batch').fill('class-6th-B-2024');
//   await page.getByPlaceholder('Enter TC Serial no. ').click();
//   await page.getByPlaceholder('Enter TC Serial no. ').fill('01');
//   await page.getByRole('rowheader').click();
